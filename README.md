...
| **FriendZoned** | Concentric circles born at each facade's center slowly expand, cracks spreading open one by one until each ring crumbles to lines and dots and shatters into flying embers at the edge, every ring spinning its own way with randomized ring-to-ring gaps; on the cylinder the rings rise base to top |
...
| **Nice** | Multi-color glowing orbs — golds, oranges, ice blues, magentas — float among the strands at varied sizes, beaming up on the abduction profile, hovering with a lantern throb, light spilling down beneath them |
...
| **Sunrise** | A huge molten sun rises slowly from the bottom of each facade, all orange and yellow, radiating thick angled beams that multiply the higher it climbs before the day turns and it sets |
